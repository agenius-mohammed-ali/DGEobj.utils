...
test_that('summarizeSigCounts.R: summarizeSigCounts()', {
    ...
    expect_equal(rownames(summarizedSigCounts), c("BDL_vs_Sham", "EXT1024_vs_BDL", "Nint_vs_BDL", "Sora_vs_BDL"))
    expect_equal(colnames(summarizedSigCounts), c("P.Value", "adj.P.Val", "Qvalue", "qvalue.lfdr", "ihw.adj_pvalue"))
    ...
    expect_equal(rownames(summarizedSigCounts_two), c("BDL_vs_Sham", "EXT1024_vs_BDL", "Nint_vs_BDL", "Sora_vs_BDL"))
    expect_equal(colnames(summarizedSigCounts_two), c("P.Value", "adj.P.Val", "Qvalue", "qvalue.lfdr", "ihw.adj_pvalue"))
